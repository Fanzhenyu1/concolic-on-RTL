...
always @(posedge clk) begin $display("achieve node: 4,1");if (rst) begin  $display("achieve node: 4,1,1");ht_out <= 32'b0; end else if (ctr_2 == 32'h12345678) begin $display("achieve node: 4,1,0,1");if (trigger == 1'b1) begin  $display("achieve node: 4,1,0,1,1");ht_out <= {ht_out[30:0], ht_out[31] ^ 1'b1}; end  else begin  $display("achieve node: 4,1,0,1,0");ht_out <= {ht_out[30:0], ht_out[31]}; end  end else begin  $display("achieve node: 4,1,0,0");ht_out <= ht_out; end  end
