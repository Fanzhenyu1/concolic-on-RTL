    ...
    if (reset == 1'b1) begin
      ...
      case (stato)
        ...
        STANDBY: begin
          ...
          if (rtr == 1'b0) cts <= 1'b0;
        end
        GET_IN:
        if (start == 1'b0) stato <= START_TX;
        else if (key == 1'b1) begin
          voto0 <= key;
          if (((g_button ^ last_g) & (g_button)) == 1'b1) voto1 <= ~voto1;
        ...
        if (rtr == 1'b1) begin
          ...
          cts   <= 1'b1;
          if (voto0 == 1'b0 && voto1 == 1'b1 && voto2 == 1'b1 && voto3 == 1'b0) stato <= END_TX;
          else stato <= TX_2_RX;
        end
        TX_2_RX:
        if (rts == 1'b0) begin
        ...
        TEST_1: begin
          ...
          voto3 <= v_in[3];
          sign  <= 4'b1000;
          if (voto0 == 1'b1 && voto1 == 1'b1 && voto2 == 1'b1 && voto3 == 1'b1) stato <= TEST_2;
        end
        TEST_2: begin
          voto0 <= 1'b1 ^ sign[0];
          voto0 <= 1'b0 ^ sign[1];
