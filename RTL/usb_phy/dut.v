...
always @ ( i_tx_phy_state or TxValid_i or i_tx_phy_data_done or ( i_tx_phy_sft_done & !( i_tx_phy_sft_done_r) ) or i_tx_phy_append_eop_sync3 or i_rx_phy_fs_ce) begin i_tx_phy_next_state = i_tx_phy_state; i_tx_phy_tx_ready_d = 1'b0; i_tx_phy_ld_sop_d = 1'b0; i_tx_phy_ld_data_d = 1'b0; i_tx_phy_ld_eop_d = 1'b0; case (i_tx_phy_state) 3'd0: begin  if (TxValid_i) begin $display("achieve node: 32,0,1");  $display("achieve node: 32,0,1,1"); i_tx_phy_ld_sop_d = 1'b1; i_tx_phy_next_state = 3'h1; end end 3'h1: begin  if (i_tx_phy_sft_done & !(i_tx_phy_sft_done_r)) begin $display("achieve node: 32,0,2");  $display("achieve node: 32,0,2,1"); i_tx_phy_tx_ready_d = 1'b1; i_tx_phy_ld_data_d = 1'b1; i_tx_phy_next_state = 3'h2; end end 3'h2: begin  if (!(i_tx_phy_data_done) && (i_tx_phy_sft_done & !(i_tx_phy_sft_done_r))) begin $display("achieve node: 32,0,3");  $display("achieve node: 32,0,3,1"); i_tx_phy_ld_eop_d = 1'b1; i_tx_phy_next_state = 3'h3; end if (i_tx_phy_data_done && (i_tx_phy_sft_done & !(i_tx_phy_sft_done_r))) begin $display("achieve node: 32,0,3,1,1"); i_tx_phy_tx_ready_d = 1'b1; i_tx_phy_ld_data_d = 1'b1; end end 3'h3: begin  if (i_tx_phy_append_eop_sync3) begin $display("achieve node: 32,0,4");  i_tx_phy_next_state = 3'h4; end end 3'h4: begin  if (!(i_tx_phy_append_eop_sync3) && i_rx_phy_fs_ce) begin $display("achieve node: 32,0,5");  i_tx_phy_next_state = 3'h5; end end 3'h5: begin  if (i_rx_phy_fs_ce) begin $display("achieve node: 32,0,6");  $display("achieve node: 32,0,6,1"); i_tx_phy_next_state = 3'd0; end end endcase end
...
always @(i_rx_phy_dpll_state or i_rx_phy_rx_en or(i_rx_phy_rxd_r != i_rx_phy_rxd_s)) begin $display("achieve node: 54,0"); i_rx_phy_fs_ce_d = 1'b0; case (i_rx_phy_dpll_state) 2'h0: begin  if (i_rx_phy_rx_en && (i_rx_phy_rxd_r != i_rx_phy_rxd_s)) begin $display("achieve node: 54,0,1");  $display("achieve node: 54,0,1,1"); i_rx_phy_dpll_next_state = 2'h0; end else begin $display("achieve node: 54,0,1,0");  i_rx_phy_dpll_next_state = 2'h1; end end 2'h1: begin  i_rx_phy_fs_ce_d = 1'b1; $display("achieve node: 54,0,2");  if (i_rx_phy_rx_en && (i_rx_phy_rxd_r != i_rx_phy_rxd_s)) begin $display("achieve node: 54,0,2,1"); i_rx_phy_dpll_next_state = 2'h3; end else begin $display("achieve node: 54,0,2,0");  i_rx_phy_dpll_next_state = 2'h2; end end 2'h2: begin  if (i_rx_phy_rx_en && (i_rx_phy_rxd_r != i_rx_phy_rxd_s)) begin $display("achieve node: 54,0,3");  $display("achieve node: 54,0,3,1"); i_rx_phy_dpll_next_state = 2'h0; end else begin $display("achieve node: 54,0,3,0");  i_rx_phy_dpll_next_state = 2'h3; end end 2'h3: begin  if (i_rx_phy_rx_en && (i_rx_phy_rxd_r != i_rx_phy_rxd_s)) begin $display("achieve node: 54,0,4");  $display("achieve node: 54,0,4,1"); i_rx_phy_dpll_next_state = 2'h0; end else begin $display("achieve node: 54,0,4,0");  i_rx_phy_dpll_next_state = 2'h0; end end endcase end
...
always @ ( i_rx_phy_fs_state or i_rx_phy_fs_ce or ( !( i_rx_phy_rxdp_s) & i_rx_phy_rxdn_s ) or ( i_rx_phy_rxdp_s & !( i_rx_phy_rxdn_s) ) or i_rx_phy_rx_en or i_rx_phy_rx_active or ( !( i_rx_phy_rxdp_s) & !( i_rx_phy_rxdn_s) ) or i_rx_phy_se0_s) begin i_rx_phy_synced_d = 1'b0; i_rx_phy_sync_err_d = 1'b0; i_rx_phy_fs_next_state = i_rx_phy_fs_state; if ( ( ( i_rx_phy_fs_ce && !( i_rx_phy_rx_active) ) && !( ( !( i_rx_phy_rxdp_s) & !( i_rx_phy_rxdn_s) )) ) && !( i_rx_phy_se0_s) ) begin  begin $display("achieve node: 59,0,1"); end case (i_rx_phy_fs_state) 3'h0: begin  if ((!(i_rx_phy_rxdp_s) & i_rx_phy_rxdn_s) && i_rx_phy_rx_en) begin $display("achieve node: 59,0,1,1");  $display("achieve node: 59,0,1,1,1"); i_rx_phy_fs_next_state = 3'h1; end end 3'h1: begin  if ((i_rx_phy_rxdp_s & !(i_rx_phy_rxdn_s)) && i_rx_phy_rx_en) begin $display("achieve node: 59,0,1,2");  $display("achieve node: 59,0,1,2,1"); i_rx_phy_fs_next_state = 3'h2; end else begin $display("achieve node: 59,0,1,2,0");  i_rx_phy_sync_err_d = 1'b1; i_rx_phy_fs_next_state = 3'h0; end end 3'h2: begin  if ((!(i_rx_phy_rxdp_s) & i_rx_phy_rxdn_s) && i_rx_phy_rx_en) begin $display("achieve node: 59,0,1,3");  $display("achieve node: 59,0,1,3,1"); i_rx_phy_fs_next_state = 3'h3; end else begin $display("achieve node: 59,0,1,3,0");  i_rx_phy_sync_err_d = 1'b1; i_rx_phy_fs_next_state = 3'h0; end end 3'h3: begin  if ((i_rx_phy_rxdp_s & !(i_rx_phy_rxdn_s)) && i_rx_phy_rx_en) begin $display("achieve node: 59,0,1,4");  $display("achieve node: 59,0,1,4,1"); i_rx_phy_fs_next_state = 3'h4; end else begin $display("achieve node: 59,0,1,4,0");  i_rx_phy_sync_err_d = 1'b1; i_rx_phy_fs_next_state = 3'h0; end end 3'h4: begin  if ((!(i_rx_phy_rxdp_s) & i_rx_phy_rxdn_s) && i_rx_phy_rx_en) begin $display("achieve node: 59,0,1,5");  $display("achieve node: 59,0,1,5,1"); i_rx_phy_fs_next_state = 3'h5; end else begin $display("achieve node: 59,0,1,5,0");  i_rx_phy_sync_err_d = 1'b1; i_rx_phy_fs_next_state = 3'h0; end end 3'h5: begin  if ((i_rx_phy_rxdp_s & !(i_rx_phy_rxdn_s)) && i_rx_phy_rx_en) begin $display("achieve node: 59,0,1,6");  $display("achieve node: 59,0,1,6,1"); i_rx_phy_fs_next_state = 3'h6; end else begin $display("achieve node: 59,0,1,6,0");  if ((!(i_rx_phy_rxdp_s) & i_rx_phy_rxdn_s) && i_rx_phy_rx_en) begin $display("achieve node: 59,0,1,6,0,1"); i_rx_phy_fs_next_state = 3'h0; i_rx_phy_synced_d = 1'b1; end else begin $display("achieve node: 59,0,1,6,0,0");  i_rx_phy_sync_err_d = 1'b1; i_rx_phy_fs_next_state = 3'h0; end end end 3'h6: begin  if ((!(i_rx_phy_rxdp_s) & i_rx_phy_rxdn_s) && i_rx_phy_rx_en) begin $display("achieve node: 59,0,1,7");  $display("achieve node: 59,0,1,7,1"); i_rx_phy_fs_next_state = 3'h7; end else begin $display("achieve node: 59,0,1,7,0");  i_rx_phy_sync_err_d = 1'b1; i_rx_phy_fs_next_state = 3'h0; end end 3'h7: begin  if (!(i_rx_phy_rxdp_s) & i_rx_phy_rxdn_s) begin $display("achieve node: 59,0,1,8");  $display("achieve node: 59,0,1,8,1"); i_rx_phy_synced_d = 1'b1; end i_rx_phy_fs_next_state = 3'h0; end endcase end end
