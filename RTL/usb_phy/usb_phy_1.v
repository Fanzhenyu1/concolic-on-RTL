module usb_phy (
  ...
  always @(posedge clk or negedge rst) begin
    if (!(rst)) begin
      ...
      if (!(i_tx_phy_tx_ip_sync)) begin
        ...
        if (i_rx_phy_fs_ce) begin
          if (!(i_tx_phy_sd_raw_o) || (i_tx_phy_one_cnt == 3'h6)) begin
            i_tx_phy_one_cnt <= 3'h0;
          end else begin
  ...
  always @ (  i_tx_phy_state or  TxValid_i or  i_tx_phy_data_done or  ( i_tx_phy_sft_done &  !( i_tx_phy_sft_done_r) ) or  i_tx_phy_append_eop_sync3 or  i_rx_phy_fs_ce)
    ...
    case (i_tx_phy_state)
      ...
      3'h3: begin
        if (i_tx_phy_append_eop_sync3) begin
          i_tx_phy_next_state = 3'h4;
        end
      end
      3'h4: begin
        if (!(i_tx_phy_append_eop_sync3) && i_rx_phy_fs_ce) begin
          i_tx_phy_next_state = 3'h5;
        end
      end
      3'h5: begin
        if (i_rx_phy_fs_ce) begin
          i_tx_phy_next_state = 3'd0;
        end
      end
    endcase
  end
  ...
  always @(i_rx_phy_dpll_state or i_rx_phy_rx_en or(i_rx_phy_rxd_r != i_rx_phy_rxd_s)) begin
      ...
      case (i_rx_phy_fs_state)
        3'h0: begin
          if ((!(i_rx_phy_rxdp_s) & i_rx_phy_rxdn_s) && i_rx_phy_rx_en) begin
            i_rx_phy_fs_next_state = 3'h1;
          end
        end
        3'h1: begin
          if ((i_rx_phy_rxdp_s & !(i_rx_phy_rxdn_s)) && i_rx_phy_rx_en) begin
            i_rx_phy_fs_next_state = 3'h2;
          end else begin
            i_rx_phy_sync_err_d = 1'b1;
            i_rx_phy_fs_next_state = 3'h0;
          end
        end
        3'h2: begin
          if ((!(i_rx_phy_rxdp_s) & i_rx_phy_rxdn_s) && i_rx_phy_rx_en) begin
            i_rx_phy_fs_next_state = 3'h3;
          end else begin
            i_rx_phy_sync_err_d = 1'b1;
            i_rx_phy_fs_next_state = 3'h0;
          end
  ...
  always @(posedge clk or negedge rst) begin
    if (!(rst)) begin
      ...
      if (!(i_rx_phy_shift_en)) begin
        ...
        if (i_rx_phy_fs_ce) begin
          if (!(i_rx_phy_sd_nrzi) || (i_rx_phy_one_cnt == 3'h6)) begin
            i_rx_phy_one_cnt <= 3'h0;
          end else begin
  ...
  always @(posedge clk) begin
    if ((i_rx_phy_fs_ce && i_rx_phy_shift_en) && !((i_rx_phy_one_cnt == 3'h6))) begin
  ...
  always @(posedge clk or negedge rst) begin
    if (!(rst)) begin
      ...
      if (!(i_rx_phy_shift_en)) begin
        ...
        if (i_rx_phy_fs_ce && !((i_rx_phy_one_cnt == 3'h6))) begin
  ...
  always @(posedge clk or negedge rst) begin
    if (!(rst)) begin
      ...
      if ((i_rx_phy_fs_ce && !((i_rx_phy_one_cnt == 3'h6))) && (i_rx_phy_bit_cnt == 3'h7)) begin
        i_rx_phy_rx_valid1 <= 1'b1;
      end else begin
        if ((i_rx_phy_rx_valid1 && i_rx_phy_fs_ce) && !((i_rx_phy_one_cnt == 3'h6))) begin
          i_rx_phy_rx_valid1 <= 1'b0;
        end
      end
    end
