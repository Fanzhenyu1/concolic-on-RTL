...
def constraint_build_solver(log_path=None):
    ...
    automator.add_verilog_constraints(
        ...
        verilog_assignments=[
            CDFG_dict['47,1']['action'],
            CDFG_dict['48,1']['action'],
            CDFG_dict['43,1']['action']
        ]
    )
    ...
    automator.add_verilog_constraints(
        ...
        verilog_assignments=[
            ...
            CDFG_dict['48,1']['action'],
            CDFG_dict['43,1']['action'],
            CDFG_dict['44,1']['action'],
            CDFG_dict['49,1']['action']
        ]
    )
    ...
    automator.add_verilog_constraints(
        ...
        verilog_assignments=[
            ...
            CDFG_dict['44,1']['action'],
            CDFG_dict['49,1']['action'],
            CDFG_dict['45,1']['action'],
            CDFG_dict['46,1']['action'],
            CDFG_dict['50,1']['action'],
            CDFG_dict['59,0,1,2,1']['action']
        ]
    )
    ...
    automator.add_verilog_constraints(
        cycle=4,
        verilog_conditions=[CDFG_dict['59,0,1,3,1']['condition'], CDFG_dict['59,0,1,3']['condition'], CDFG_dict['59,0,1']['condition']],
        verilog_assignments=[
            CDFG_dict['58,1,0']['action'],
            CDFG_dict['46,1']['action'],
            CDFG_dict['50,1']['action']
        ]
    )
...
def main():
    ...
    path_config = [
        ...
        },        
        {
            'cycle': 1,
            'condition_keys': [],
            'action_keys': ['47,1', '48,1', '43,1']
        },        
        {
            'cycle': 2,
            'condition_keys': [],
            'action_keys': ['47,1', '48,1', '43,1', '44,1', '49,1']
        },
        {
            'cycle': 3,
            'condition_keys': [],
            'action_keys': ['47,1', '48,1', '43,1', '44,1', '49,1', '45,1', '46,1', '50,1', '59,0,1,2,1']
        },
        {
            'cycle': 4,
            'condition_keys': ['59,0,1,3,1', '59,0,1,3', '59,0,1'],
            'action_keys': ['58,1,0', '46,1', '50,1']
        }        
    ]
    # 约束代码生成
    ...
    log_path="./RTL/usb_phy/constraint_solve.log"
    # # 约束建立&求解
